...
public class WebSocketClient extends org.java_websocket.client.WebSocketClient {
    ...
    private NewContactOrGroupPoll newContactOrGroupPollProcessor;
    ...
    public WebSocketClient(DiscordAPIImpl api, String url) {
        ...
        newContactOrGroupPollProcessor = new NewContactOrGroupPoll(api);
        this.connect();
    }
        ...
        try {
            ...
            switch (type) {
                ...
                case "CHANNEL_CREATE":
                    ...
                    newContactOrGroupPollProcessor.process(key, obj, server);
                    break;
                default:
